defmodule UroWeb.Components.PasswordField do
  @moduledoc """
  The `UroWeb.Components.PasswordField` module is a Phoenix component designed to render a customizable
  ...
  def password_field(%{floating: floating} = assigns) when floating in ["inner", "outer"] do
    ...
    <div class={[
      ...
      <div class={[
        ...
        <div :if={@show_password} class={["flex items-center justify-center shrink-0 pe-2", @show_pass_class]}>
          <button
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(UroWeb.Components.PasswordField.Gettext, "errors", msg, opts)
    end
  end
end
