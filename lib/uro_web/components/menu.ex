defmodule UroWeb.Components.Menu do
  @moduledoc """
  The `UroWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `UroWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import UroWeb.Components.Accordion, only: [accordion: 1]
  import UroWeb.Components.Button, only: [button_link: 1]
