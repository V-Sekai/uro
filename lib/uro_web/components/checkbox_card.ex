defmodule UroWeb.Components.CheckboxCard do
  @moduledoc """
  The `UroWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
        ...
        >
          ...
          <div data-part="label" class="checkbox-card-content-wrapper flex-1">
            ...
            >
              ...
              />
              <div :if={checkbox[:title]} class="block checkbox-card-title leading-[16px] font-semibold">
                {checkbox[:title]}
              </div>
