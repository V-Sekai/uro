defmodule VertexWeb.API.V1.Dashboard.UserContent.AvatarController do
  ...
  def index(conn, _params) do
    ...
    |> json(%{
      data: %{
        avatars:
          VertexWeb.Helpers.UserContentHelper.get_api_user_content_list(
            avatars,
  ...
  def create(conn, %{"avatar" => avatar_params}) do
    case UserContent.create_avatar(
           VertexWeb.Helpers.UserContentHelper.get_correct_user_content_params(
             conn,
             avatar_params,
