defmodule VertexWeb.Helpers.UserContentHelper do
  @doc false
  def merge_map_with_base_user_content(map, user_content) do
    ...
    |> Map.merge(%{
      ...
      user_content_data:
        to_string(
          Vertex.Uploaders.UserContentData.url({user_content.user_content_data, user_content})
        ),
      user_content_preview:
        to_string(
          Vertex.Uploaders.UserContentPreview.url(
            {user_content.user_content_preview, user_content}
          )
        )
    })
  end
